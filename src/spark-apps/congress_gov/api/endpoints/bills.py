...
# from data_providers.congress_gov.api.congress_api import CongressAPI
from datetime import date, datetime
from typing import List, Literal, Optional, Union, get_args

# from congress_gov.api.congress_api import CongressAPI

# from ..congress_api import CongressAPI
from ..dto.bills import SUB_ENTITIES, BillSummaryDTO, BillDetailsDTO

from ..congress_api import CongressAPI


class BillsEndpoint(CongressAPI):
