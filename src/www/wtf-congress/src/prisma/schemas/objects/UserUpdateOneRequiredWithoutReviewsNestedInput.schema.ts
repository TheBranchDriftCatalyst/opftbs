...
const Schema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutReviewsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutReviewsInputObjectSchema)
        .optional(),
...
export const UserUpdateOneRequiredWithoutReviewsNestedInputObjectSchema =
  Schema;
