...
const Schema: z.ZodType<Prisma.StoryUpdateManyWithoutAuthorNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => StoryUpsertWithWhereUniqueWithoutAuthorInputObjectSchema),
        z
          .lazy(() => StoryUpsertWithWhereUniqueWithoutAuthorInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => StoryUpdateWithWhereUniqueWithoutAuthorInputObjectSchema),
        z
          .lazy(() => StoryUpdateWithWhereUniqueWithoutAuthorInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const StoryUpdateManyWithoutAuthorNestedInputObjectSchema = Schema;
