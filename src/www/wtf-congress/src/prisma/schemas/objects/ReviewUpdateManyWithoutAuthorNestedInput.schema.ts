...
const Schema: z.ZodType<Prisma.ReviewUpdateManyWithoutAuthorNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ReviewUpsertWithWhereUniqueWithoutAuthorInputObjectSchema),
        z
          .lazy(() => ReviewUpsertWithWhereUniqueWithoutAuthorInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => ReviewUpdateWithWhereUniqueWithoutAuthorInputObjectSchema),
        z
          .lazy(() => ReviewUpdateWithWhereUniqueWithoutAuthorInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const ReviewUpdateManyWithoutAuthorNestedInputObjectSchema = Schema;
