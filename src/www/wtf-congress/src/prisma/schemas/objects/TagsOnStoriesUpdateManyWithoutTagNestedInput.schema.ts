...
const Schema: z.ZodType<Prisma.TagsOnStoriesUpdateManyWithoutTagNestedInput> = z
  .object({
    create: z
      .union([
...
export const TagsOnStoriesUpdateManyWithoutTagNestedInputObjectSchema = Schema;
