...
const Schema: z.ZodType<Prisma.ReviewUncheckedCreateNestedManyWithoutAuthorInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewUncheckedCreateNestedManyWithoutAuthorInputObjectSchema =
  Schema;
