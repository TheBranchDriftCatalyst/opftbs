...
const Schema: z.ZodType<Prisma.TagsOnStoriesUncheckedCreateNestedManyWithoutTagInput> =
  z
    .object({
      create: z
        .union([
...
export const TagsOnStoriesUncheckedCreateNestedManyWithoutTagInputObjectSchema =
  Schema;
