...
import { ReviewUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema } from './ReviewUncheckedUpdateManyWithoutAuthorNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateInput> = z
  .object({
    ...
    loggedInAt: z
      ...
      .nullable(),
    reviews: z
      .lazy(() => ReviewUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema)
      .optional(),
    Story: z
