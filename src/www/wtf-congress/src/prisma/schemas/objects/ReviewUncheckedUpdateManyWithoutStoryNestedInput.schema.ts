...
const Schema: z.ZodType<Prisma.ReviewUncheckedUpdateManyWithoutStoryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ReviewUpsertWithWhereUniqueWithoutStoryInputObjectSchema,
          ),
          z
            .lazy(
              () => ReviewUpsertWithWhereUniqueWithoutStoryInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ReviewUpdateWithWhereUniqueWithoutStoryInputObjectSchema,
          ),
          z
            .lazy(
              () => ReviewUpdateWithWhereUniqueWithoutStoryInputObjectSchema,
...
export const ReviewUncheckedUpdateManyWithoutStoryNestedInputObjectSchema =
  Schema;
