...
const Schema: z.ZodType<Prisma.ReviewUpdateManyWithWhereWithoutAuthorInput> = z
  .object({
...
export const ReviewUpdateManyWithWhereWithoutAuthorInputObjectSchema = Schema;
