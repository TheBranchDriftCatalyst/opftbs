...
const Schema: z.ZodType<Prisma.ChapterUpdateManyWithoutStoryNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ChapterUpsertWithWhereUniqueWithoutStoryInputObjectSchema),
        z
          .lazy(() => ChapterUpsertWithWhereUniqueWithoutStoryInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => ChapterUpdateWithWhereUniqueWithoutStoryInputObjectSchema),
        z
          .lazy(() => ChapterUpdateWithWhereUniqueWithoutStoryInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const ChapterUpdateManyWithoutStoryNestedInputObjectSchema = Schema;
